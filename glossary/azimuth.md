...
The primary way to interact with Azimuth and to manage your identities is through our [Bridge](../bridge) application. Bridge is a front-end for [Ecliptic](../ecliptic), the Azimuth contract that's used to perform actions on the blockchain.
